...
## 2. Pros y contras de las herramientas utilizadas
...
Para poder correr estas pruebas se requiere ya tener instalado el aplicativo **GHOST** en su versión **3.42.5**. 
...
### 4. Pasos para correr las pruebas con Playwright
...
### 5. Pasos para correr las pruebas con Kraken
...
### 6. Funcionalidades bajo pruebas y escenarios
